    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg p-0 bg-white shadow-2xl rounded-xl">
        ...
        <div className="p-5 max-h-[70vh] overflow-y-auto">
          ...
          {correct.length > 0 && (
            <div className="mb-5">
              <h4 className="text-base font-semibold text-emerald-600 mb-2 flex items-center">
              ...
              <ul className="space-y-2">
                {correct.map((r) => (
                  <li
                    key={r.id}
                    className="bg-emerald-50 rounded-lg p-3 flex items-center gap-3 text-sm"
                  >
          ...
          {incorrect.length > 0 && (
            <div>
              <h4 className="text-base font-semibold text-rose-600 mb-2 flex items-center">
              ...
              <ul className="space-y-2">
                {incorrect.map((r) => (
                  <li
                    key={r.id}
                    className="bg-rose-50 rounded-lg p-3 flex items-center gap-3 text-sm"
                  >
